...
// only built when Vaultwarden is actually being reconciled.
func init() {
	configurator.MustRegisterFactory("apps-vaultwarden", func(deps configurator.Deps) configurator.NodeLifecycle {
