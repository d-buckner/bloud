...
// Backward-compatible: delegates to GenerateAll with no remote apps.
...
func (g *Generator) GenerateAll(apps []*catalog.App, remoteApps []RemoteAppRoute) error {
	config := g.generateConfig(apps, remoteApps)
...
func (g *Generator) generateConfig(apps []*catalog.App, remoteApps []RemoteAppRoute) string {
